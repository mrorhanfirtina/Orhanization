...
namespace Monstersoft.VennWms.Main.Application.Features.LocationFeatures.LocationCodeFormats.Dtos.DtoValidators;

public class UpdateLocationCodeFormatSubDtoValidator : AbstractValidator<UpdateLocationCodeFormatSubDto>
{
    public UpdateLocationCodeFormatSubDtoValidator()
    {
