...
public class CreateLocationProductConstraintSubDtoValidator : AbstractValidator<CreateLocationProductConstraintSubDto>
{
    public CreateLocationProductConstraintSubDtoValidator()
    {
