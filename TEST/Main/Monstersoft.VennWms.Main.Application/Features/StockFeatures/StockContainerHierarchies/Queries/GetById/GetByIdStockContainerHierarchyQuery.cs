...
namespace Monstersoft.VennWms.Main.Application.Features.StockFeatures.StockContainerHierarchies;

public class GetByIdStockContainerHierarchyQuery : IRequest<GetByIdStockContainerHierarchyResponse>, ITransactionalRequest, ILoggableRequest, ISecuredRequest, ILocalityRequest
{
    ...
    public class GetByIdStockContainerHierarchyQueryHandler : IRequestHandler<GetByIdStockContainerHierarchyQuery, GetByIdStockContainerHierarchyResponse>
    {
        ...
        public GetByIdStockContainerHierarchyQueryHandler(IStockContainerHierarchyRepository stockContainerHierarchyRepository, IMapper mapper, StockContainerHierarchyBusinessRules stockContainerHierarchyBusinessRules)
        {
        ...
        public async Task<GetByIdStockContainerHierarchyResponse> Handle(GetByIdStockContainerHierarchyQuery request, CancellationToken cancellationToken)
        {
            ...
            {
                return _mapper.Map<GetByIdStockContainerHierarchyResponse>(await _stockContainerHierarchyRepository.GetAsync(x => x.Id == request.Id,
                include: x =>
                {
