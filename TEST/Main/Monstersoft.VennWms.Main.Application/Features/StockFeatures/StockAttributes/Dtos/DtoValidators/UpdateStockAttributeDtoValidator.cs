...
namespace Monstersoft.VennWms.Main.Application.Features.StockFeatures.StockAttributes.Dtos.DtoValidators;

public class UpdateStockAttributeDtoValidator : AbstractValidator<UpdateStockAttributeDto>
{
    public UpdateStockAttributeDtoValidator()
    {
