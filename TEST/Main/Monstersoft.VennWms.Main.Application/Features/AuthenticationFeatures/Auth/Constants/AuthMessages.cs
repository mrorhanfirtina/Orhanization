...
namespace Monstersoft.VennWms.Main.Application.Features.AuthenticationFeatures.Auth.Constants;
...
public static class AuthMessages
{
    ...
    public const string EmailAlreadyExists = "Email adresi daha önceden tanımlanmış.";
}
