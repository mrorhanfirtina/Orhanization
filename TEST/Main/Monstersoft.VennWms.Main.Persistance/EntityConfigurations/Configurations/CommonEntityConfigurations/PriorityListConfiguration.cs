...
public class PriorityListConfiguration : IEntityTypeConfiguration<PriorityList>
{
    public void Configure(EntityTypeBuilder<PriorityList> builder)
    {
        #region Tablo Tanımları
        builder.ToTable("PriorityLists", "common").HasKey(p => p.Id);
        #endregion
        ...
        builder.HasIndex(p => new { p.Code, p.Description, p.Priority, p.CreatedDate }, name: "IX_PriorityList_Areas");
        #endregion
