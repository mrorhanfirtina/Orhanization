...
public class ExpectedSerialHierarchyConfiguration : IEntityTypeConfiguration<ExpectedSerialHierarchy>
{
    public void Configure(EntityTypeBuilder<ExpectedSerialHierarchy> builder)
    {
        #region Tablo Tanımları
        builder.ToTable("ExpectedSerialHierarchies", "serial").HasKey(p => p.Id);
        #endregion
        ...
        builder.HasOne(p => p.RootSerial).WithMany().HasForeignKey(p => p.RootSerialId).OnDelete(DeleteBehavior.Restrict);
