...
public class PoAttributeConfiguration : IEntityTypeConfiguration<PoAttribute>
{
    public void Configure(EntityTypeBuilder<PoAttribute> builder)
    {
        #region Tablo Tanımları
        builder.ToTable("PoAttributes").HasKey(p => p.Id);
        #endregion
        ...
        #region Indexler
        builder.HasIndex(indexExpression: p => p.Code, name: "UK_PoAttributes_Code").IsUnique();
        builder.HasIndex(indexExpression: p => p.Description, name: "UK_PoAttributes_Description").IsUnique();
        #endregion
