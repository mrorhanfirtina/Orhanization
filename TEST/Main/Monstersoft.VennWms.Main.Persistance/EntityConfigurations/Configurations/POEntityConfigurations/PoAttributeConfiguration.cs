...
public class PoAttributeConfiguration : IEntityTypeConfiguration<PoAttribute>
{
    public void Configure(EntityTypeBuilder<PoAttribute> builder)
    {
        ...
        builder.ToTable("PoAttributes", "po").HasKey(p => p.Id);
        #endregion
        ...
        builder.HasIndex(p => new { p.Code, p.Description, p.AttributeInputTypeId, p.DepositorCompanyId, p.CreatedDate }, name: "IX_PoAttributes_Areas");
        #endregion
