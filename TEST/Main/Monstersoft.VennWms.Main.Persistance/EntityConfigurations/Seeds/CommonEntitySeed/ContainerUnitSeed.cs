...
public class ContainerUnitSeed : IEntityTypeConfiguration<ContainerUnit>
{
    public void Configure(EntityTypeBuilder<ContainerUnit> builder)
    {
        builder.HasData(
                ...
                new ContainerUnit { Id = 5, Code = "DRM", FirstDigit = "D", Description = "Drum", CountryCode = "40", ProducerCode = "1234567", Counter = "501", CreatedDate = DateTime.Now, DepositorCompanyId = Guid.Parse("dd4d5460-8146-4e62-ac19-a74d89955dd7") },
                new ContainerUnit { Id = 6, Code = "CNT", FirstDigit = "C", Description = "Container", CountryCode = "40", ProducerCode = "1234567", Counter = "601", CreatedDate = DateTime.Now, DepositorCompanyId = Guid.Parse("dd4d5460-8146-4e62-ac19-a74d89955dd7") },
                new ContainerUnit { Id = 7, Code = "MXP", FirstDigit = "M", Description = "Mix Pallet", CountryCode = "40", ProducerCode = "1234567", Counter = "601", CreatedDate = DateTime.Now, DepositorCompanyId = Guid.Parse("dd4d5460-8146-4e62-ac19-a74d89955dd7") }
            );
    }
}
