...
{ 
    ...
    public LogStock(Guid id, Guid transactionLogId, Guid stockId, Guid productId, Guid fromLocationId, Guid toLocationId, decimal quantity, int transactionTypeId) : this()
    {
        Id = id;
