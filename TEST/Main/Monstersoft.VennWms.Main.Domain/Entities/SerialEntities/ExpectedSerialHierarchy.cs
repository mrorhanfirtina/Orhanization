...
public class ExpectedSerialHierarchy : Entity<Guid>
{
    ...
    public ExpectedSerialHierarchy()
    {
    }

    public ExpectedSerialHierarchy(Guid rootSerialId, Guid childSerialId) : this()
    {
